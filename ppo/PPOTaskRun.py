...
if __name__ == '__main__':
    ...
    for update in range(1, args.num_updates + 1):
        ...
        (meta_params, agent_state, key, episode_stats, next_obs, terminated, truncated, handle), (loss, pg_loss, v_loss, entropy_loss, approx_kl) = ppo_task.inner_epoch((meta_params, agent_state, key, episode_stats, next_obs, terminated, truncated, handle), 0)
